      ...
      <div class="row">
        ...
        <div class="col-12">
          <ul id="menu-header-menu" class="menu sidebar-mobile-menu flex flex-column flex-align-center">
            <li id="menu-item-2137" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2133 current_page_item menu-item-2137">
              <span>Real Money Pokies</span>
            </li>
            <li id="menu-item-608" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-608">
            ...
            <li id="menu-item-6652" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-6652">
              ...
              <ul class="sub-menu">
                ...
                <li id="menu-item-6507" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-6507">
